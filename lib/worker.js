...
var _debugEs = require('./debugEs');

var _debugEs2 = _interopRequireDefault(_debugEs);
  ...
  _createClass(Job, [{
    ...
    value: function _claimJob(job) {
      ...
      return this.client.update({
        ...
        _this2.debug('err.statusCode was 409 - returning FALSE');
    ...
    value: function _performJob(job) {
      ...
      var workerOutput = new Promise(function (resolve, reject) {
        ...
        if (job._source == null) {
          ...
          p = (0, _debugEs2.default)(_this4.client, _this4.queue.index);
        } else {
          p = Promise.resolve();
        }
        p.then(function foo() {
          Promise.resolve(that.workerFn.call(null, job._source.payload)).then(function (res) {
            isResolved = true;
            resolve(res);
          }).catch(function (err) {
            isResolved = true;
    ...
    value: function _claimPendingJobs(jobs) {
      ...
      return jobs.reduce(function (chain, job) {
        return chain.then(function (claimedJob) {
          _this6.debug('chain.then claimedJob is....' + JSON.stringify(claimedJob, undefined, 2));
    ...
    value: function _getPendingJobs() {
      ...
      return this.client.search({
        ...
        if (jobs.length > 0) {
          _this7.debug(JSON.stringify(jobs, undefined, 2));
        }
        return jobs;
      }).catch(function (err) {
